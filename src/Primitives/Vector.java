...
public class Vector implements Comparable<Vector>{
    ...
    public void setVector(Vector v)	{this._head.setPoint3D(v._head);}
    ...
    public String toString(){ //Using Point3D toString()
        return _head.toString();
    }

    // ***************** Operations ******************** //

    public void add (Vector vector ){ //Vectors add Using Point3D add
        this._head.add(vector);
    }

    public void subtract (Vector vector ){ //Vectors sub Using Point3D sub
        this._head.subtract(vector);
    }

    public void scale(double scalingFacor){ //Scaling factor mult
    ...
    public Vector crossProduct (Vector vector){ //Vector mult
    ...
    public void normalize() { //Vector Normalize
    ...
    public double dotProduct(Vector vector) { //Dot product
